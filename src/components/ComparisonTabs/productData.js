export const productData = {
  tabletop: {
    ...
    sections: [
      {
        title: 'Overview',
        rows: [{ label: 'Ideal For', values: ['5 Users', '25 Users', '50 Users', '100 Users'] }]
      },
      {
        title: 'Performance',
        rows: [
          { label: 'UTM (Full Scan)', values: ['280 Mbps', '510 Mbps', '710 Mbps', '1.83 Gbps'] },
          { label: 'Firewall (UDP 1518)', values: ['1.02 Gbps', '2.28 Gbps', '3.9 Gbps', '7.9 Gbps'] },
          { label: 'VPN (UDP 1518)', values: ['640 Mbps', '1.44 Gbps', '1.94 Gbps', '5.8 Gbps'] },
          { label: 'VPN (IMIX)', values: ['210 Mbps', '480 Mbps', '680 Mbps', '1.14 Gbps'] },
          { label: 'AntiVirus', values: ['450 Mbps', '880 Mbps', '1.06 Gbps', '3 Gbps'] },
          { label: 'IPS (Full Scan)', values: ['375 Mbps', '725 Mbps', '1.03 Gbps', '2.41 Gbps'] },
          { label: 'HTTPS (Full Scan)', values: ['140 Mbps', '270 Mbps', '380 Mbps', '1 Gbps'] }
        ]
      },
      {
        title: 'VPN Tunnels',
        rows: [
          { label: 'Branch Office VPN Tunnels', values: ['5', '10', '25', '100'] },
          { label: 'Mobile VPN', values: ['5', '10', '25', '100'] }
        ]
      },
      {
        title: 'Hardware',
      ...
      },
      {
        ...
        rows: [
          { label: 'VLAN', values: ['Unrestricted', 'Unrestricted', 'Unrestricted', 'Unrestricted'] },
