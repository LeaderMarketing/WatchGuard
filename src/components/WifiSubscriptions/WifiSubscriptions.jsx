    ...
    <section className={`${styles.section} ${disabled ? styles.disabled : ''}`}>
      ...
      {disabled && (
        <div className={styles.disabledNotice}>
          <span>⚠️</span> License selection is not available when purchasing appliance only.
        </div>
      )}
      ...
      <div className={styles.licensesGrid}>
        <button
          ...
          onClick={() => !disabled && onSelectWifiLicense && onSelectWifiLicense('Standard Wi-Fi')}
          disabled={disabled}
        >
        ...
        <button
          ...
          onClick={() => !disabled && onSelectWifiLicense && onSelectWifiLicense('USP Wi-Fi')}
          disabled={disabled}
        >
